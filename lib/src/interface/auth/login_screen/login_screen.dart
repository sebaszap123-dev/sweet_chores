...
class _LoginScreenState extends State<LoginScreen> {
                                                                    ...
                                                                    GestureDetector(
                                                                        ...
                                                                        child: RichText(
                                                                            text: TextSpan(children: [
                                                                              TextSpan(text: "lbl_new_here".tr, style: CustomTextStyles.bodyMedium13),
                                                                              const TextSpan(text: " "),
                                                                              TextSpan(text: "lbl_register".tr, style: CustomTextStyles.labelLargeSFProText)
                                                                            ]),
  ...
  onTapTxtForgotpassword(BuildContext context, ConnectivityResult? data) {
    if (data != null &&
  ...
  void onTapLoginWithGoogle(
      BuildContext context, ConnectivityResult? data) async {
    if (data != null &&
        data != ConnectivityResult.none &&
        data != ConnectivityResult.bluetooth) {
      setState(() {
